<template>
  <div class="container mx-auto max-w-6xl px-3">
    ...
    <p>
      The Jill Pill ("us", "we", or "our") operates the https://thejillpill.com
    ...
    <p>
      ...
      have associated with that data. The Privacy Policy for The Jill Pill is
      based on the
    ...
    <p>
      ...
      accessible from https://thejillpill.com
    </p>
    ...
    <ul>
      <li>
        ...
        <p>
          Service is the https://thejillpill.com website operated by The Jill
          Pill
        </p>
      </li>
      <li>
    ...
    <p>
      The Jill Pill will take all steps reasonably necessary to ensure that your
    ...
    <p>
      The Jill Pill may disclose your Personal Data in the good faith belief
    ...
    <ul>
      <li>By email: thejillpillmethod@gmail.com</li>
    </ul>
  </div>
</template>
